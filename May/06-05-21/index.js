...
// Promises are the best solution if you want to do something that takes a long time to be done and
// you don't want your app to wait for it to be done, so it will work on the background,
